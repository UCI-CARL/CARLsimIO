...
programOptions()
{
	...
	desc.add_options()
		...
		("duration,d", po::value<double>()->default_value(30.0), "Duration of the Simulation in Seconds")
		("speed", po::value<double>()->default_value(1.0), "Speedfactor of the Simulation Time")
		...
		("autosync", po::value<unsigned>()->default_value(3), "1: waits until the buffer is not empty and use the first timestamp as simtime. 0: no synchronisation")
